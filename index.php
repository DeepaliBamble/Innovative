...
<head>
    ...
    <meta name="description" content="Discover Innovative Homesi - where comfort meets craftsmanship. Premium sofas and furniture designed to last, built with sustainable materials and timeless design. Custom pieces tailored to your vision. Your home, your story, our craft.">
    <meta name="keywords" content="sofa manufacturer, custom furniture, premium sofas, furniture design, sustainable furniture, luxury sofas, custom sofa design, furniture craftsmanship, home furniture, innovative homesi">
    ...
    <meta property="og:description" content="Transform your space with handcrafted sofas and furniture. Blending timeless craftsmanship with modern design. Built to last, designed to inspire.">
    ...
    <meta name="twitter:description" content="Transform your space with handcrafted sofas and furniture. Blending timeless craftsmanship with modern design.">
...
<body>
    ...
    <div id="wrapper">
        ...
        <section class="flat-spacing">
            <div class="container">
                <div class="sect-title text-center wow fadeInUp">
                    ...
                    <p class="s-subtitle h6" style="text-transform: none;">Explore furniture by category to find the perfect pieces that match your style, space, and comfort needs.</p>
                </div>
                                ...
                                <a href="<?php echo $categoryUrl; ?>" class="widget-collection style-circle hover-img">
                                    <div class="collection_image img-style">
                                        <img class="lazyload"
                                             ...
                                             data-src="<?php echo $categoryImage; ?>"
        ...
        <section class="flat-spacing pt-0 tf-pag-swiper">
            <div class="container">
                <div class="sect-title text-center wow fadeInUp">
                    ...
                    <p class="s-subtitle h6" style="text-transform: none;">Discover our latest furniture designs, crafted to elevate comfort and style.</p>
                </div>
        ...
        <section class="flat-spacing pt-0" style="background: linear-gradient(135deg, #faf8f6 0%, #f5f0eb 100%);">
            <div class="container">
                <div class="text-center mb-5 wow fadeInUp">
                    <h1 class="sect-title" style="color: #9e6747; font-size: 2.5rem; margin-bottom: 1rem; padding-top: 2rem;">What our customers say</h1>
                    <p style="color: #666; font-size: 1.1rem; max-width: 600px; margin: 0 auto;">Discover why thousands of customers trust us for their home furnishing needs</p>
                </div>
                ...
                <div class="testimonial-container" style="max-width: 1200px; margin: 0 auto; position: relative;">
                    <div dir="ltr" class="swiper testimonial-swiper wow fadeInUp">
                        <div class="swiper-wrapper">
                            <!-- Testimonial 1 -->
                            <div class="swiper-slide">
                                <div class="testimonial-card" style="background: white; border-radius: 20px; padding: 3rem 2.5rem; box-shadow: 0 10px 40px rgba(158, 103, 71, 0.1); position: relative; margin: 20px;">
                                    <div class="quote-icon" style="position: absolute; top: -15px; left: 30px; width: 50px; height: 50px; background: #9e6747; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                    ...
                                    <h4 style="color: #9e6747; font-size: 1.4rem; margin-bottom: 1rem; font-weight: 600;">A sofa that reflects your personality</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card" style="background: white; border-radius: 20px; padding: 3rem 2.5rem; box-shadow: 0 10px 40px rgba(158, 103, 71, 0.1); position: relative; margin: 20px;">
                                    ...
                                    <h4 style="color: #9e6747; font-size: 1.4rem; margin-bottom: 1rem; font-weight: 600;">Exceptional quality and craftsmanship</h4>
                    ...
                    <!-- Navigation Buttons -->
                    <div class="testimonial-navigation" style="display: flex; justify-content: center; gap: 15px; margin-top: 3rem;">
                        <button class="testimonial-prev" style="width: 50px; height: 50px; border-radius: 50%; background: white; border: 2px solid #9e6747; color: #9e6747; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(158, 103, 71, 0.15);">
                            <i class="icon icon-caret-left" style="font-size: 20px;"></i>
                        </button>
                        <button class="testimonial-next" style="width: 50px; height: 50px; border-radius: 50%; background: #9e6747; border: 2px solid #9e6747; color: white; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(158, 103, 71, 0.25);">
        ...
        <section class="flat-spacing">
            <div class="container">
                <div class="sect-title text-center wow fadeInUp">
                    ...
                    <p class="s-subtitle h6" style="text-transform: none;">Inspiration and insights for creating spaces that truly feel like home</p>
                </div>
                <?php if (!empty($blogs)): ?>
                <div dir="ltr" class="swiper tf-swiper" data-preview="3" data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="48"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        ?>
                        <div class="swiper-slide">
                            <div class="article-blog type-space-2 hover-img4 wow fadeInLeft" data-wow-delay="<?php echo $delay; ?>s">
                                <a href="blog-detail.php?slug=<?php echo urlencode($blog['slug']); ?>" class="entry_image img-style4">
                                    <img src="<?php echo $blogImage; ?>" data-src="<?php echo $blogImage; ?>" alt="<?php echo htmlspecialchars($blog['title']); ?>" class="lazyload aspect-ratio-1">
                                </a>
                                <div class="entry_tag">
                                    <a href="blogs.php?category=<?php echo urlencode($blog['category']); ?>" class="name-tag h6 link"><?php echo $publishedDate; ?></a>
                                </div>

                                <div class="blog-content">
                                    <a href="blog-detail.php?slug=<?php echo urlencode($blog['slug']); ?>" class="entry_name link h4">
                                        <?php echo htmlspecialchars($blog['title']); ?>
                                    </a>
                                    <p class="text h6">
                                        <?php echo $excerpt; ?>
                                    </p>
                                    <a href="blog-detail.php?slug=<?php echo urlencode($blog['slug']); ?>" class="tf-btn-line">
                                        Read more
                                    </a>
                                </div>
                            </div>
                ...
                <div dir="ltr" class="swiper tf-swiper wow fadeInUp" data-preview="5" data-tablet="4" data-mobile-sm="3" data-mobile="2"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img hover-overlay">
                                <div class="image img-style">
                                    <img class="lazyload" src="images/gallery/gallery-19.jpg" data-src="images/gallery/gallery-19.jpg" alt="Instagram Reel">
                                </div>
                                <a href="https://www.instagram.com/reel/C8CF0WIo7AE/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" class="box-icon hover-tooltip">
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img hover-overlay">
                                <div class="image img-style">
                                    <img class="lazyload" src="images/gallery/gallery-20.jpg" data-src="images/gallery/gallery-20.jpg" alt="Instagram Reel">
                                </div>
                                <a href="https://www.instagram.com/reel/DQ4FnPDAqeb/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" class="box-icon hover-tooltip">
                                    <span class="icon icon-instagram-logo" style="color: #9e6747;"></span>
                                    <span class="tooltip">Watch on Instagram</span>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img hover-overlay">
                                <div class="image img-style">
                                    <img class="lazyload" src="images/gallery/gallery-21.jpg" data-src="images/gallery/gallery-21.jpg" alt="Instagram Reel">
                                </div>
                                <a href="https://www.instagram.com/reel/DPx7sDHAkQg/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" class="box-icon hover-tooltip">
                                    <span class="icon icon-instagram-logo" style="color: #9e6747;"></span>
                                    <span class="tooltip">Watch on Instagram</span>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img hover-overlay">
                                <div class="image img-style">
                                    <img class="lazyload" src="images/gallery/gallery-22.jpg" data-src="images/gallery/gallery-22.jpg" alt="Instagram Reel">
                                </div>
                                <a href="https://www.instagram.com/reel/DOX4jfGE5hQ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" class="box-icon hover-tooltip">
                                    <span class="icon icon-instagram-logo" style="color: #9e6747;"></span>
                                    <span class="tooltip">Watch on Instagram</span>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img hover-overlay">
                                <div class="image img-style">
                                    <img class="lazyload" src="images/gallery/gallery-23.jpg" data-src="images/gallery/gallery-23.jpg" alt="Instagram Reel">
                                </div>
                                <a href="https://www.instagram.com/reel/DMfRhXHyQNn/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer" class="box-icon hover-tooltip">
                                    <span class="icon icon-instagram-logo" style="color: #9e6747;"></span>
                                    <span class="tooltip">Watch on Instagram</span>
                                </a>
                            </div>
            ...
            <div class="modal-content align-items-md-center">
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner tf-product-info-list">
                        ...
                        <a href="product-countdown-timer.php" class="tf-btn-line text-normal letter-space-0 fw-normal">
            ...
            <div class="wrap-recommendations">
                <div class="list-cart">
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/decor/product-1.jpg" src="images/products/decor/product-1.jpg" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                                <a class="link text-line-clamp-1" href="product-countdown-timer.php">Nike Sportswear Tee Shirts</a>
                            </h6>
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/decor/product-3.jpg" src="images/products/decor/product-3.jpg" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                                <a class="link text-line-clamp-1" href="product-countdown-timer.php">Puma Essentials Graphic Tee</a>
                            </h6>
                            <div class="cart-item-bot">
                                <div class="price-wrap price">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/decor/product-5.jpg" src="images/products/decor/product-5.jpg" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                                <a class="link text-line-clamp-1" href="product-countdown-timer.php">Reebok Classic Crew Sweatshirt</a>
                            </h6>
                            <div class="cart-item-bot">
                                <div class="price-wrap price">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/decor/product-7.jpg" src="images/products/decor/product-7.jpg" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                                <a class="link text-line-clamp-1" href="product-countdown-timer.php">Columbia PFG Fishing Shirt</a>
                            </h6>
                            <div class="cart-item-bot">
                                <div class="price-wrap price">
                            ...
                            <div class="tf-mini-cart-items list-empty">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="images/products/decor/product-9.jpg" src="images/products/decor/product-9.jpg"
                                            alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">T-shirt</div>
                                        <h6 class="title">
                                            <a href="product-countdown-timer.php" class="link text-line-clamp-1">Queen fashion long sleeve shirt, basic
                                                t-shirt</a>
                                        </h6>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">T-shirt</div>
                                        <h6 class="title">
                                            <a href="product-countdown-timer.php" class="link text-line-clamp-1">Champion Reverse Weave Pullover</a>
                                        </h6>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="h6 fw-semibold">
                                                <span class="number">1x</span>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        ...
                                        <h6 class="title">
                                            <a href="product-countdown-timer.php" class="link text-line-clamp-1">ASICS Core Running Tights</a>
                                        </h6>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="h6 fw-semibold">
                                                <span class="number">1x</span>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        ...
                                        <h6 class="title">
                                            <a href="product-countdown-timer.php" class="link text-line-clamp-1">New Balance Athletics Shorts</a>
                                        </h6>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="h6 fw-semibold">
                                                <span class="number">1x</span>
